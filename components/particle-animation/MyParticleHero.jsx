 ...
 *
 * Source package: public/icons/nl3/particle/section-2
 * Image asset:    public/icons/nl3/particle/section-2/scene.png
 * Props match particle-scene.json (Studio export) — do not rewrite the engine.
 */
